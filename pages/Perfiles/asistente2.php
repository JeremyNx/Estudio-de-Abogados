...
<section class="py-5 bg-white">
  <div class="container">
    <div class="row g-5 align-items-start">
      ...
      <!-- Imagen -->
      <div class="col-md-5">
        <img src="/assets/img/usuarios/IMG_1642.webp" class="img-fluid rounded shadow" alt="Foto asistente">
      ...
      <div class="col-md-7">
        ...
        <h2 class="profile-heading">Sebastián Leonardo Acevedo Montesinos</h2>
        ...
        <div class="profile-section">
          ...
          <p>4to año de Derecho en la Universidad Nacional Mayor de San Marcos</p>
        </div>

        <!-- Experiencia -->
        <div class="profile-section">
          <div class="profile-section-title">
            <i class="fas fa-briefcase profile-icon"></i> Experiencia Laboral
          </div>
          <ul class="experience-list">
            <li>
              Dic 2023 – Abril 2024: Apoyo en la Fiscalía Supraprovincial Corporativa Especializada en Delitos de
              Corrupción de Funcionarios
            </li>
            <li>
              Abril 2024 – Mayo 2025: Estudio Gutiérrez & Rosas
            </li>
            <li>
        ...
        <div class="profile-section">
          ...
          <ul class="list-unstyled practice-areas">
            <li><i class="fas fa-shield-alt"></i> Derecho Penal</li>
            <li><i class="fas fa-gavel"></i> Derecho Administrativo</li>
