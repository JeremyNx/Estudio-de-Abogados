...
<section class="py-5 bg-white">
  <div class="container">
    <div class="row g-5 align-items-start">
      ...
      <!-- Imagen -->
      <div class="col-md-5">
        <img src="https://www.pngmart.com/files/21/Abogado-PNG-HD-Isolated.png" class="img-fluid rounded shadow" alt="Nombre Abogado">
      </div>

      <!-- Información -->
      <div class="col-md-7">
        <!-- Nombre y Especialidad -->
        <h2 class="profile-heading">Dr. Nombre del Abogado</h2>
