...
<section class="py-5 bg-white">
  <div class="container">
    <div class="row g-5 align-items-start">
      ...
      <!-- Imagen -->
      <div class="col-md-5">
        <img src="/assets/img/usuarios/IMG_1682.webp" class="img-fluid rounded shadow" alt="Foto Abogado">
      </div>

      <!-- Información -->
      <div class="col-md-7">
        <!-- Nombre y Especialidad -->
        <h2 class="profile-heading">Dra. Kimberly Tejada Zegarra</h2>
        ...
        <div class="profile-section">
          ...
          <p>Universidad San Martín de Porres - Egresada de la Maestría en Ciencias Penales</p>
        </div>

        <!-- Experiencia -->
        <div class="profile-section">
          <div class="profile-section-title"><i class="fas fa-briefcase profile-icon"></i> Experiencia Laboral</div>
          <p>Abogada con más de 7 años de experiencia, especializada en Derecho Penal y Derecho Procesal Penal. Con sólida experiencia en litigios penales, de familia y civil, contando con amplia experiencia en procesos penales, la legislación vigente, análisis jurídico, investigación y redacción de escritos legales. Comprometida con la búsqueda de soluciones justas y eficaces.</p>
        </div>
        ...
        <div class="profile-section">
          ...
          <ul class="list-unstyled practice-areas">
            ...
            <li><i class="fas fa-file-contract"></i> Derecho Procesal Penal</li>
            <li><i class="fas fa-gavel"></i> Derecho Civil</li>
            <li><i class="fas fa-shield-alt"></i> Derecho Constitucional</li>
          </ul>
        </div>
