...
<section class="py-5 bg-white">
  <div class="container">
    <div class="row g-5 align-items-start">
      ...
      <!-- Imagen -->
      <div class="col-md-5">
        <img src="/assets/img/usuarios/IMG_1617.webp" class="img-fluid rounded shadow" alt="Foto asistente">
      </div>

      <!-- Información -->
      <div class="col-md-7">
        <!-- Nombre y Especialidad -->
        <h2 class="profile-heading">Melvin Carlos Ramos Gonzales</h2>
        ...
        <div class="profile-section">
          ...
          <p>4to año de carrera tercio superior - Universidad Nacional Mayor de San Marcos v.</p>
        </div>

        <!-- Experiencia -->
        <div class="profile-section">
          <div class="profile-section-title"><i class="fas fa-briefcase profile-icon"></i> Experiencia Laboral</div>
          <p>7 meses en el estudio Valdivia Abogados & Consultores.</p>
        </div>
        ...
        <div class="profile-section">
          ...
          <ul class="list-unstyled practice-areas">
            ...
            <li><i class="fas fa-users"></i> Derecho procesal civil</li>
            <li><i class="fas fa-file-contract"></i> Derecho de familia</li>
            <li><i class="fas fa-user-tie"></i> Derecho Laboral</li>
          </ul>
        </div>
