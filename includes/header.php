...
<div id="preloader">
  <div class="preloader-content animate__animated animate__fadeInDown">
    ...
    <!-- Texto de bienvenida -->
    <h1 class="welcome-text">Cargando página web</h1>
      ...
      <div class="collapse navbar-collapse justify-content-center" id="mainNavbar">
        ...
        <div class="d-flex align-items-center gap-4 flex-column flex-lg-row">
          ...
          <ul class="navbar-nav flex-column flex-lg-row text-center text-lg-start">
            ...
            <li class="nav-item">
              <a class="nav-link <?= str_contains($current, '/pages/nosotros') ? 'active' : '' ?>"
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link <?= str_contains($current, '/pages/equipo') ? 'active' : '' ?>"
                href="/pages/equipo.php">Equipo</a>
            </li>
